...
NationalParkSnubbullScript:
	faceplayer
	opentext
	writetext NationalParkSnubbullText
	cry SNUBBULL
	waitbutton
	closetext
	end
...
NationalPark_MapEvents:
	...
	warp_event  0, 53, NATIONAL_PARK_GROTTO, 1
	warp_event  1, 53, NATIONAL_PARK_GROTTO, 2
	def_coord_events
	...
	object_event 26, 40, SPRITE_SNUBBULL_OW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, NationalParkSnubbullScript, -1
	...
	object_event  2, 27, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, NationalParkTMDig, EVENT_NATIONAL_PARK_TM_DIG
