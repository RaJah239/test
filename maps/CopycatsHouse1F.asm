...
CopycatsHouse1FVulpixScript:
	opentext
	writetext CopycatsHouse1VulpixText
	cry VULPIX
	waitbutton
	closetext
	end
...
CopycatsHouse1F_MapEvents:
	...
	object_event  6,  6, SPRITE_VULPIX_OW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CopycatsHouse1FVulpixScript, -1
