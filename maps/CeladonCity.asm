...
CeladonCityPoliwhirlScript:
	opentext
	writetext CeladonCityPoliwhirlText
	cry POLIWHIRL
	waitbutton
	closetext
	end
...
CeladonCity_MapEvents:
	...
	object_event 27, 11, SPRITE_POLIWHIRL_OW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeladonCityPoliwhirlScript, -1
