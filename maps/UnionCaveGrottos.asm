...
UnionCaveGrottos_MapEvents:
	...
	object_event  5,  2, SPRITE_MACHOP, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_EMOTE, OBJECTTYPE_SCRIPT, 0, UnionCaveGrottoMachop, EVENT_UNION_CAVE_GROTTO_MACHOP_OW
