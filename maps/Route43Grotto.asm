...
Route43Grotto_MapEvents:
	...
	object_event  5,  9, SPRITE_SKARMORY_OW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_EMOTE, OBJECTTYPE_SCRIPT, 0, Route43GrottoSkarmoryScript, EVENT_ROUTE_42_GROTTO_SKARMORY
