...
FuchsiaMart_MapEvents:
	...
	object_event  1,  2, SPRITE_DELIBIRD_MART, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, FuchsiaDelibirdScript, -1
