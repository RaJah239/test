...
SlowpokeWellB2F_MapEvents:
	...
	warp_event  9, 11, SLOWPOKE_WELL_B1F, 1
	...
	def_object_events
	object_event 10,  5, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 1, SlowpokeWellB2FGymGuideScript, -1
