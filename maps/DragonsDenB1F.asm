...
DragonsDenB1F_MapEvents:
	...
	warp_event 34, 15, DRAGONS_DEN_GROTTO, 1
	...
	def_object_events
	object_event 35, 21, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DragonsDenB1FDragonFangScript, EVENT_DRAGONS_DEN_B1F_DRAGON_FANG
