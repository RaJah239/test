...
GoldenrodCityYoungster1LetMeGetOutYourWayText:
	text "I best be on my"
	line "way too…"
	
	para "So much again to"
	line "see out there."
...
GoldenrodCity_MapEvents:
	...
	object_event 20, 16, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster2Script, EVENT_GOLDENROD_CITY_CIVILIANS
