...
EcruteakCity_MapEvents:
	...
	object_event  5,  6, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BurnedTowerSuperNerdScript, EVENT_BURNED_TOWER_BLOCKER
