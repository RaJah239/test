...
PokemonFanClubOddishScript:
	opentext
	writetext PokemonFanClubOddishText
	cry ODDISH
	waitbutton
	closetext
	end
...
PokemonFanClub_MapEvents:
	...
	object_event  7,  3, SPRITE_ODDISH_OW, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PokemonFanClubOddishScript, -1
