...
MountMortar1FInsideHiddenMaxRepel:
	hiddenitem MAX_REVIVE, EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_MAX_REPEL
...
MountMortar1FInside_MapEvents:
	...
	object_event  7, 32, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideHyperPotion, EVENT_MOUNT_MORTAR_1F_INSIDE_HYPER_POTION
