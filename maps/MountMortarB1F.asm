...
MountMortarB1FZapdos:
	...
	startbattle
	disappear MOUNTMORTARB1F_ZAPDOS
...
MountMortarB1F_MapEvents:
	...
	object_event 24, 27, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortarB1FCarbos, EVENT_MOUNT_MORTAR_B1F_CARBOS
	...
	object_event  4, 15, SPRITE_ZAPDOS, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MountMortarB1FZapdos, EVENT_MOUNTMORTARB1F_ZAPDOS
