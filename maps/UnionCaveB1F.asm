...
UnionCaveB1F_MapEvents:
	...
	warp_event 15, 21, UNION_CAVE_GROTTOS, 1
	...
	object_event  5, 18, SPRITE_CHANSEY_OW, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, UnionCaveChanseyScript, -1
