...
Route10PokecenterChanseyScript:
...
Route10Pokecenter1F_MapEvents:
	...
	object_event  4,  1, SPRITE_CHANSEY_OW, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route10PokecenterChanseyScript, -1
