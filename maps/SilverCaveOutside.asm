...
MaximaMatchAfterText:
	...
	object_event 27, 20, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, MaximaScript, EVENT_MAXIMA_APPEAR_MT_SILVER_OUTSIDE
