...
EcruteakGymMortyScript:
	...
	clearevent EVENT_ROUTE_42_ECRUTEAK_GATE_SCARLET
	setevent EVENT_ROUTE_42_ECRUTEAKGATE_OFFICER_BLOCKER
	setmapscene ROUTE_42_ECRUTEAK_GATE, SCENE_ROUTE42ECRUTEAKGATE_SCARLET_BATTLE
	opentext
...
.FightDone:
	...
	setevent EVENT_DANCE_THEATRE_SCARLET
