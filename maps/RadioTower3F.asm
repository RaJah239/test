...
RadioTower3F_MapEvents:
	...
	object_event  2,  1, SPRITE_CHANSEY_OW, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RadioTower3FChanseyScript, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	object_event  3,  1, SPRITE_PORYGON_OW, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RadioTower3FPorygonPCScript, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
