...
Route34_MapEvents:
	...
	warp_event  6, 53, ROUTE_34_GROTTO, 1
	warp_event  7, 53, ROUTE_34_GROTTO, 2
	...
	object_event  6, 49, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerCooltrainerfKate, -1
