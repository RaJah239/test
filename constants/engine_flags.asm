...
; wDailyFlags3 - only 8 daily Flags can be added here
	const ENGINE_DAILY_UNION_CAVE_GROTTOS
	const ENGINE_DAILY_CIANWOOD_GROTTOS
	const ENGINE_DAILY_ROUTE_29_GROTTO
	const ENGINE_DAILY_DARK_CAVE_WEST_GROTTO
	const ENGINE_DAILY_RUINS_OF_ALPH_GROTTO
	const ENGINE_DAILY_ROUTE_32_GROTTO
	const ENGINE_DAILY_SLOWPOKE_WELL_GROTTO
	const ENGINE_DAILY_ILEX_FOREST_GROTTO
