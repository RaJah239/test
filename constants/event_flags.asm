...
; Crytal Trove events start here.
	...
	const EVENT_ROUTE_29_GROTTO_SENTRET
	...
	const EVENT_DARK_CAVE_WEST_GROTTO_RHYHORN
	...
	const EVENT_ROUTE_34_GROTTO_PIDGEOTTO
	...
	const EVENT_ROUTE_36_GROTTO_MAREEP
