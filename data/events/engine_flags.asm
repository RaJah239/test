...
; entries correspond to ENGINE_* constants
	...
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_UNION_CAVE_GROTTOS_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_CIANWOOD_GROTTOS_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_ROUTE_29_GROTTO_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_DARK_CAVE_WEST_GROTTO_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_RUINS_OF_ALPH_GROTTO_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_ROUTE_32_GROTTO_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_SLOWPOKE_WELL_GROTTO_F
	engine_flag wDailyFlags3, DAILYFLAGS3_ENGINE_DAILY_ILEX_FOREST_GROTTO_F
