...
; here to place my events that initialize on game start
	...
	dw EVENT_VICTORY_ROAD_ERIC_THE_EXPLORER
	dw EVENT_NO_E4_REMATCH_UNTIL_RED_IS_BEATEN
	dw EVENT_ROUTE_45_RAIKOU
	dw EVENT_BURNED_TOWER_ENTEI
	dw EVENT_ROUTE_42_STATIONARY_SUICUNE
	dw EVENT_ROUTE_38_ECRUTEAKGATE_OFFICER
	dw EVENT_ROUTE_42_ECRUTEAKGATE_OFFICER
	dw EVENT_SILVER_CAVE_ITEM_ROOMS_MEWTWO
	dw EVENT_CELADON_MANSION_ROOF_TEAM_ROCKET_ARCHER
	dw EVENT_TOHJO_FALLS_GIOVANNI
	dw EVENT_REDS_HOUSE_1F_RED_IS_HOME
	dw EVENT_FLOWER_SHOP_FLORINA_GIVES_BERRIES
	dw EVENT_ROUTE_29_TUSCANY_OF_TUESDAY
	dw EVENT_UNION_CAVE_1F_SCARLET
	dw EVENT_ROUTE_30_BERRY_TEACHER
	dw EVENT_PLAYERS_NEIGHBOR_SCARLET_HOME
	dw EVENT_NEW_BARK_TOWN_SCARLET_LEAVES_HOME
	dw EVENT_ROUTE_32_SCARLET
	dw EVENT_ROUTE_42_ECRUTEAK_GATE_SCARLET
	dw EVENT_OLIVINE_LIGHT_HOUSE_3F_SCARLET
	dw EVENT_NEW_BARK_TOWN_SCARLET_BATTLE_WHEN_LEAVING_FOR_LEAGUE
	dw -1 ; end
