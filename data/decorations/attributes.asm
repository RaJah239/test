...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    CLEFAIRY,        SET_UP_DOLL,       EVENT_DECO_CLEFAIRY_DOLL,           SPRITE_FAIRY
	...
	decoration DECO_DOLL,    POLIWHIRL,       SET_UP_DOLL,       EVENT_DECO_POLIWAG_DOLL,            SPRITE_POLIWHIRL_OW
	decoration DECO_DOLL,    DIGLETT,         SET_UP_DOLL,       EVENT_DECO_DIGLETT_DOLL,            SPRITE_DIGLETT_OW
	decoration DECO_DOLL,    WOOPER,          SET_UP_DOLL,       EVENT_DECO_WOOPER_DOLL,             SPRITE_WOOPER_OW
	...
	decoration DECO_DOLL,    GASTLY,          SET_UP_DOLL,       EVENT_DECO_GASTLY_DOLL,             SPRITE_GASTLY_OW
	...
	decoration DECO_DOLL,    GEODUDE,         SET_UP_DOLL,       EVENT_DECO_GEODUDE_DOLL,            SPRITE_GEODUDE_OW
	decoration DECO_DOLL,    MACHOP,          SET_UP_DOLL,       EVENT_DECO_MACHOP_DOLL,             SPRITE_MACHOP
	decoration DECO_DOLL,    TENTACRUEL,      SET_UP_DOLL,       EVENT_DECO_TENTACRUEL_DOLL,         SPRITE_TENTACRUEL_OW
