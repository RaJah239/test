...
FalknerGroup:
	...
	db  1, PIDGEY,     SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 1, CLEFAIRY,   SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; WHITNEY (2)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 11, CLEFAIRY,   SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 1, METAPOD,    SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; BUGSY (2)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 11, METAPOD,    SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 1, GASTLY,     SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
PryceGroup:
	...
	db 1, SEEL,       SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; PRYCE (2)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 12, SEEL,       SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
JasmineGroup:
	...
	; JASMINE (2)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 13, SEEL,       SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
ChuckGroup:
	...
	; CHUCK (2)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 11, SEEL,       SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 1, DRAGONAIR,  SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; CLAIR (2)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 11, DRAGONAIR,  SPLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
WillGroup:
	...
	; WILL (2)
	db "WILL@", TRAINERTYPE_MOVES
	db 4, XATU,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	; BRUNO (2)
	db "BRUNO@", TRAINERTYPE_MOVES
	db 4, HITMONTOP,  PURSUIT, QUICK_ATTACK, DIG, DETECT
	db -1 ; end
...
KarenGroup:
	...
	; KAREN (2)
	db "KAREN@", TRAINERTYPE_MOVES
	db 4, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db -1 ; end
...
KogaGroup:
	...
	; KOGA (2)
	db "KOGA@", TRAINERTYPE_MOVES
	db 4, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db -1 ; end
...
ChampionGroup:
	...
	; CHAMPION (2)
	db "LANCE@", TRAINERTYPE_MOVES
	db 4, GYARADOS,   FLAIL, RAIN_DANCE, SURF, HYPER_BEAM
	db -1 ; end
...
BrockGroup:
	...
	db "BROCK@", TRAINERTYPE_MOVES
	db 4, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db -1 ; end
...
MistyGroup:
	...
	; MISTY (2)
	db "MISTY@", TRAINERTYPE_MOVES
	db 4, GOLDUCK,    SURF, DISABLE, PSYCH_UP, PSYCHIC_M
	db -1 ; end
...
LtSurgeGroup:
	...
	; LT_SURGE (2)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 4, RAICHU,     THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	; ERIKA (2)
	db "ERIKA@", TRAINERTYPE_MOVES
	db 2, TANGELA,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db -1 ; end
...
JanineGroup:
	...
	; JANINE (2)
	db "JANINE@", TRAINERTYPE_MOVES
	db 1, CROBAT,     SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db -1 ; end
...
SabrinaGroup:
	...
	; SABRINA (2)
	db "SABRINA@", TRAINERTYPE_MOVES
	db 4, ESPEON,     SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db -1 ; end
...
BlaineGroup:
	...
	; BLAINE (1)
	db "BLAINE@", TRAINERTYPE_MOVES
	db 4, MAGCARGO,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
	db -1 ; end
...
RedGroup:
	...
	; RED (2)
	db "RED@", TRAINERTYPE_MOVES
	db 11, PIKACHU,    CHARM, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db -1 ; end
...
BlueGroup:
	...
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 5, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db -1 ; end
...
ScarletGroup:
	; SCARLET (1) - CYNDAQUIL_PLAYER
	db "SCARLET@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_ITEM_MOVES
	db 5, CHIKORITA
		db "HAZEL@"
		db PERFECT_DV, PERFECT_DV ; atk|def dv, spd|spc dv
		db BERRY
		db TACKLE, GROWL, NO_MOVE, NO_MOVE
	db -1 ; end

	; SCARLET (2) - TOTODILE_PLAYER
	db "SCARLET@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_ITEM_MOVES
	db 5, CYNDAQUIL
		db "CINDER@"
		db PERFECT_DV, PERFECT_DV ; atk|def dv, spd|spc dv
...
ScarletFinalGroup:
	; SCARLET_FINAL (1) - CYNDAQUIL_PLAYER
	db "SCARLET@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_ITEM_MOVES
	db 100, MEGANIUM
		db "HAZEL@"
		db PERFECT_DV, PERFECT_DV ; atk|def dv, spd|spc dv
		db MIRACLEBERRY
		db SLEEP_POWDER, GIGA_DRAIN, EARTHQUAKE, BODY_SLAM
	db -1 ; end
